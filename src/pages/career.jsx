...
export default function CareerPage() {
  ...
  return (
    <section className="w-full h-full flex flex-col items-center gap-8 overflow-x-hidden bg-highlight_background">
      ...
      <section className="w-full h-72 mt-14 bg-cover bg-center flex flex-row items-center justify-center text-white px-4 bg-primary">
        <div className="text-center">
        <h1 className="text-5xl font-bold text-white px-6 py-2 rounded-lg">
